...
class DeckModel {
  ...
  int sortCardComparison(CardModel card1, CardModel card2) {
    final cardTypes1 = CardModel.getCardTypesString(card1.cardTypes).toLowerCase();
    final cardTypes2 = CardModel.getCardTypesString(card2.cardTypes).toLowerCase();
    var cardPosition1 = 0;
    var cardPosition2 = 0;
    ...
    return card1.cardCost.debt.compareTo(card2.cardCost.debt);
    }
    return card1.cardCost.potion.compareTo(card2.cardCost.potion);
    }
    return card1.cardCost.coin.compareTo(card2.cardCost.coin);
    }
